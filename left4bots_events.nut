...
::Left4Bots.Events.OnGameEvent_player_spawn <- function (params)
{
	...
	Left4Timers.AddTimer(null, 0.01, @(params) ::Left4Bots.OnPostPlayerSpawn.bindenv(::Left4Bots)(params.player, params.userid), { player = player, userid = params["userid"].tointeger(), rawin = null });
}
